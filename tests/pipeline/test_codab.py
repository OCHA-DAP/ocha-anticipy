...
def test_codab_download(pipeline, downloader, mock_aa_data_dir):
...
def test_codab_load_admin_level(pipeline, gpd_read_file, mock_aa_data_dir):
    ...
    gpd_read_file.assert_called_with(
        f"zip:///{mock_aa_data_dir}/public/raw/{ISO3}/{_MODULE_BASENAME}/"
...
def test_codab_custom(pipeline, gpd_read_file, mock_aa_data_dir):
