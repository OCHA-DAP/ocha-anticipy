...
def geo_bounding_box():
    ...
    gbb = GeoBoundingBox(
        lat_max=1.0, lat_min=-2.24, lon_max=3.34, lon_min=-4.4
    )
    return gbb
...
def test_reanalysis_download(
    ...
    expected_result_path = Path(
        ...
        f"cems-glofas-historical_v4_2021_Np1d025Sm2d275Ep3d375Wm4d425.grib"
    )
...
def test_forecast_download(
    ...
    expected_result_path = Path(
        ...
        f"{mock_country_config.iso3}_"
        f"cems-glofas-forecast_v4_2022-01-01_"
        f"ltmax03d_Np1d025Sm2d275Ep3d375Wm4d425"
        f".grib"
    )
    mock_retrieve.assert_called_with(**expected_retrieve_args)
    mock_result.return_value.download.assert_called_with(
...
def test_reforecast_download(
    ...
    expected_result_path = Path(
        ...
        f"{mock_country_config.iso3}_"
        f"cems-glofas-reforecast_v4_2018-03_"
        f"ltmax03d_Np1d025Sm2d275Ep3d375Wm4d425"
        f".grib"
    )
    mock_retrieve.assert_called_with(**expected_retrieve_args)
...
def test_reforecast_download_v3(
    mock_country_config,
    mock_aa_data_dir,
    mock_retrieve,
    mock_result,
    ...
    expected_result_path = Path(
        ...
        f"glofas/cems-glofas-reforecast/"
        f"{mock_country_config.iso3}_"
        f"cems-glofas-reforecast_v3_2018-01_ltmax03d_Np1d05Sm2d35Ep3d45Wm4d45"
        f".grib"
    )
    mock_retrieve.assert_called_with(**expected_retrieve_args)
    mock_result.return_value.download.assert_called_with(
