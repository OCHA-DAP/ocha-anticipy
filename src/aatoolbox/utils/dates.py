...
def _get_dekadal_date(
    ...
    if isinstance(input_date, str):
        year, dekad = _date_to_dekad(date.fromisoformat(input_date))
    elif isinstance(input_date, date):
        year, dekad = _date_to_dekad(input_date)
    else:
...
def _dekad_to_date(year: int, dekad: int) -> date:
...
def _date_to_dekad(date_obj: date) -> Tuple[int, int]:
...
def _compare_dekads_lt(y1: int, d1: int, y2: int, d2: int) -> bool:
...
def _compare_dekads_lte(y1: int, d1: int, y2: int, d2: int) -> bool:
...
def _compare_dekads_gt(y1: int, d1: int, y2: int, d2: int) -> bool:
...
def _compare_dekads_gte(y1: int, d1: int, y2: int, d2: int) -> bool:
